    ...
    return (
        <>
            ...
            <div className="container content-with-filters">
                <div className="container notifications__container notifications__search-from form-margin">
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <form action="#" method="post">
                                <div className="input-group notifications__search-container">
                                    <input type="text" className="form-control notifications__search-input"
                                           name="search_input"
                                           id="search-input" placeholder="Поиск..."/>
                                    <div className="input-group-append">
                                        <button className="btn btn-dark notifications__search-btn" type="submit">Поиск
                                        </button>
                                    </div>
                                </div>
                            </form>
